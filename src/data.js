...
export const CHALLENGE_DEFS = {
  steps: {
    ...
    dates: 'May 3–9', emoji: '👟',
    days: [
      { label: 'Sun, May 3',  date: '2026-05-03' },
      { label: 'Mon, May 4',  date: '2026-05-04' },
      { label: 'Tue, May 5',  date: '2026-05-05' },
      { label: 'Wed, May 6',  date: '2026-05-06' },
      { label: 'Thu, May 7',  date: '2026-05-07' },
      { label: 'Fri, May 8',  date: '2026-05-08' },
      { label: 'Sat, May 9',  date: '2026-05-09' },
    ],
  ...
  water: {
    ...
    days: [
      { label: 'Sun, May 10', date: '2026-05-10' },
